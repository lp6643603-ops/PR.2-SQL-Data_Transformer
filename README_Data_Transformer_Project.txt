...
PROJECT OVERVIEW
----------------
This project is a MySQL database project named `data\_transformer`.
...
------------------
1. Database Creation
   Creates the `data\_transformer` database and selects it for use.
...
video link
https://drive.google.com/file/d/1cXi9H-EYFZiFrONjZgsil32BQPjCiQYk/view?usp=drive_link